        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Polls for Pi.</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link to="/get_started" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Polls</Link>
                  </li>
                  {/* <li className="mb-1">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link to="/faqs" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">FAQs</Link>
                  </li>
                  {/* <li className="mb-1">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link to="/about" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Blurtopian</Link>
                  </li>
                  {/* <li className="mb-1">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                <a href="https://twitter.com/blurtopian/" target="_blank" rel="noreferrer noopener" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Twitter">
              ...
              <li className="ml-4">
                <a href="https://github.com/pi-apps/polls-for-pi" target="_blank" rel="noreferrer noopener" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Github">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; eastmael. All rights reserved.</div>
